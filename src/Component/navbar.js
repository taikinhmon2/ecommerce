        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container d-flex justify-content-between">
                    <Link className="navbar-brand fs-3 font-monospace fw-bolb" to="/">Luân-Jerry FASHION</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent" >
                        ...
                        <div className="buttons">
                            ...
                            <Link to="/cart" className="btn btn-outline-secondary " tabIndex="-1" role="button" aria-disabled="true"><FontAwesomeIcon className="me-2" icon={faCartShopping} />Card({productStore.length})</Link>
                        </div>
                    </div>
